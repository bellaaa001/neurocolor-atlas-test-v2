// Navigation and page management - updated for Stage 2-3 tasks
const NAVIGATION = {
    ...
    render() {
        ...
        switch (currentPage) {
            case 'setup':
                ...
                setTimeout(() => UI_CONTROLS.setupEventListeners?.(), 0);
                break;
            case 'consent':
            ...
            case 'aft':
                ...
                setTimeout(() => AFT_MODULE.setupEventListeners(), 0);
                break;
            case 'practice':
    ...
    startScientificTask() {
        ...
        SCIENTIFIC_TASK.startFullscreen();
        setTimeout(() => SCIENTIFIC_TASK.runTrial(), 500);
    },
    ...
    stopTest() {
        ...
        if (confirmed) {
            ...
            alert('Test stopped. You can download your data from the summary page or restart.');
            NAVIGATION.goToPage(8); // Go to summary page
        }
    },
    ...
    updateSessionInfo() {
        ...
        if (sessionInfo) {
            const info = `Session: ${STATE.sessionId ? STATE.sessionId.substring(0, 12) + '...' : 'New'} | Participant: ${STATE.participantId || 'Not Set'} | Page: ${STATE.currentPageIndex + 1}/${CONFIG.PAGES.length}`;
